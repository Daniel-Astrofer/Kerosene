...
class _TotpScreenState extends ConsumerState<TotpScreen> {
  ...
  _TotpIssueData _missingDigitsIssue() {
    return _TotpIssueData(
      ...
      message: context.tr.totpEnter6Digits,
    );
  }
  ...
  String _headline() {
    ...
    switch (_sceneState) {
      ...
      case _TotpSceneState.verifying:
        return context.tr.totpVerifying;
      case _TotpSceneState.success:
        return _t(
  ...
  String _body() {
    ...
    switch (_sceneState) {
      case _TotpSceneState.review:
        if (_isSetupMode) {
          return context.tr.totpSetupSubtitle;
        }
        return _t(
      ...
      case _TotpSceneState.verifying:
        return _isSetupMode
            ? context.tr.totpAuthenticating
            : context.tr.totpEstablishingSession;
      case _TotpSceneState.success:
        return _isSetupMode
            ? _t(
  ...
  String _primaryButtonText() {
    ...
    return _isSetupMode
        ? context.tr.totpVerifyButton
        : context.tr.totpVerifyContinue;
  }
  ...
  Widget _buildSupportPanel(BuildContext context, Color accentColor) {
    final message = _issue?.message ??
        (_isSetupMode ? context.tr.totpHint : context.tr.unknownDeviceHelper);
