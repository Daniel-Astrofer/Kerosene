  ...
  Widget build(BuildContext context) {
    ...
    return SignupStepLayout(
      ...
      highlightHint: _selectedOption == SeedSecurityOption.slip39
          ? context.tr.seedSlip39Summary(_threshold, _totalShares)
      ...
      footer: SignupPrimaryFooter(
        text: context.tr.seedSecurityContinue,
        ...
        if (_selectedOption == SeedSecurityOption.slip39) ...[
          ...
          SignupPanel(
            ...
            child: Column(
              ...
              children: [
                Text(
                  context.tr.seedSlip39ConfigTitle,
                ...
                _ConfigCounter(
                  title: context.tr.seedSlip39TotalShares,
                ...
                _ConfigCounter(
                  title: context.tr.seedSlip39Threshold,
