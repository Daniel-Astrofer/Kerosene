...
export 'transaction_statement_screen.dart';
...
class _DepositsScreenState extends ConsumerState<DepositsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final canShowNfc =
        ref.watch(receiveNfcCompatibilityProvider).asData?.value == true;
  ...
  Widget _buildMethodSelection(
    ...
    final showNfcOption = isInternal && canShowNfc;
    const receiveMethodLabel = 'Como deseja receber';
    final subtitle = switch (kind) {
      _ReceiveWalletKind.internal => showNfcOption
