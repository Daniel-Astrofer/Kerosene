...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    if (widget.openNotificationsPane) {
      return const _SettingsPaneDetailScreen(pane: SettingsPane.notifications);
    }
  ...
  Route<void> _settingsPaneRoute(SettingsPane pane) {
    return PageRouteBuilder<void>(
      pageBuilder: (_, __, ___) => _SettingsPaneDetailScreen(pane: pane),
...
class _SettingsPaneDetailScreen extends StatelessWidget {
  ...
  const _SettingsPaneDetailScreen({required this.pane});
