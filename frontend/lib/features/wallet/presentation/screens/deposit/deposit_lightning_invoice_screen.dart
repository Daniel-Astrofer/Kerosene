                  ...
                  return SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: AppSpacing.xl),
                        _buildDetailsBlock(networkFeeFiat, providerFeeFiat,
                                receiveBtc, sats)
        ...
        children: [
          ...
          Text(
            ...
            style: Theme.of(context)
                .textTheme
                .displayLarge!
                .copyWith(fontSize: 40, fontFamily: 'JetBrainsMono'),
          ),
          const SizedBox(height: AppSpacing.md),
          Container(
    ...
    return GlassContainer(
      ...
      child: Text(
        ...
        style: Theme.of(context)
            .textTheme
            .titleLarge!
            .copyWith(fontFamily: 'JetBrainsMono', fontWeight: FontWeight.bold),
      ),
    );
  }

  Widget _buildDetailsBlock(
      double networkFee, double providerFee, double receiveBtc, int sats) {
    return GlassContainer(
      padding: const EdgeInsets.all(AppSpacing.lg),
      borderRadius: BorderRadius.circular(AppSpacing.xl),
      child: Column(
        children: [
          _buildDetailRow('Taxa de Rede (Lightning)',
              'R\$ ${networkFee.toStringAsFixed(2).replaceAll('.', ',')}'),
          const SizedBox(height: AppSpacing.sm),
          _buildDetailRow('Taxa do Provedor',
