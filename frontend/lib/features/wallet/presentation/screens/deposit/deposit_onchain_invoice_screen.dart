...
class DepositOnchainInvoiceScreen extends ConsumerWidget {
                  ...
                  return SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: AppSpacing.xl),
                        _buildDetailsBlock(price, networkFeeFiat,
                                providerFeeFiat, receiveBtc)
        ...
        children: [
          ...
          Text(
            ...
            style: AppTypography.h1
                .copyWith(fontSize: 32, fontFamily: 'JetBrainsMono'),
          ),
  ...
  Widget _buildDetailsBlock(double btcPrice, double networkFee,
      double providerFee, double receiveBtc) {
    return GlassContainer(
      padding: const EdgeInsets.all(AppSpacing.lg),
      borderRadius: BorderRadius.circular(AppSpacing.xl),
      child: Column(
        children: [
          _buildDetailRow('Cotação BTC',
              'R\$ ${btcPrice.toStringAsFixed(2).replaceAll('.', ',')}'),
          const SizedBox(height: AppSpacing.sm),
          _buildDetailRow('Taxa de Rede',
              'R\$ ${networkFee.toStringAsFixed(2).replaceAll('.', ',')}'),
          const SizedBox(height: AppSpacing.sm),
          _buildDetailRow('Taxa de Serviço',
