...
class ReceiveQrScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ReceiveFlowScaffold(
      title: context.tr.receiveQrTitle,
      subtitle: context.tr.receiveQrSubtitle,
      child: Column(
        children: [
          ReceiveFlowPanel(
      ...
      children: [
        Expanded(
          child: _ActionIconButton(
            onTap: () {
              ...
              SnackbarHelper.showSuccess(context.tr.receiveQrCopied);
            },
            icon: LucideIcons.copy,
            label: context.tr.copy.toUpperCase(),
          ),
        ),
        ...
        Expanded(
          child: _ActionIconButton(
            ...
            label: context.tr.share.toUpperCase(),
          ),
        ),
      ],
    );
