...
class _NfcInteractionScreenState extends State<NfcInteractionScreen>
  ...
  void didChangeDependencies() {
    ...
    if (_statusMessage.isEmpty) {
      _statusMessage = context.tr.waitingConnection;
    }
  }
  ...
  void _startNfcSession() async {
    ...
    if (availability != NfcAvailability.enabled) {
      if (mounted) {
        setState(() {
          _statusMessage = context.tr.nfcUnavailable;
        });
      }
      return;
    }
  ...
  void _handleError(String msg) {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      if (mounted) {
        setState(() => _statusMessage = context.tr.waitingConnection);
        _startNfcSession();
      }
    });
  }
        ...
        children: [
          ...
          Text(
            (widget.paymentUri != null
                ? context.tr.receive.toUpperCase()
                : context.tr.send.toUpperCase()),
  ...
  Widget _buildAmount() {
    return Column(
      children: [
        Text(
          widget.paymentUri != null
              ? context.tr.amountToReceive.toUpperCase()
              : context.tr.amount.toUpperCase(),
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Text(
            context.tr.cancelOperation.toUpperCase(),
            style: Theme.of(context).textTheme.labelSmall!.copyWith(
                  color: Theme.of(
                    context,
                  ).colorScheme.onPrimary.withValues(alpha: 0.4),
